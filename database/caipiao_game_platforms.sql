...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Game Platforms';

-- Insert SLOT platforms (Category 1: NO_HU)
...
-- Insert LIVE CASINO platforms (Category 2: CASINO)
INSERT INTO `caipiao_game_platforms` (`id`, `category_id`, `code`, `name`, `product_code`, `pt_percent`, `sort_order`, `status`) VALUES
...
-- Insert FISHING platforms (Category 3: BAN_CA)
INSERT INTO `caipiao_game_platforms` (`id`, `category_id`, `code`, `name`, `product_code`, `pt_percent`, `sort_order`, `status`) VALUES
